"""
Django settings for time_41321 project.
...
WSGI_APPLICATION = 'time_41321.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "time_41321 API",
    "DESCRIPTION": "API documentation for time_41321 App",
    "VERSION": "v1",
}
